...
SECRET_KEY = '7i*ea)pi8x%31%r124m(^z!ud3pta5exi9cqaw!m&^@5k=8ew('
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'scanner_app/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Ensure you have this configuration for static files
STATIC_URL = '/static/'
